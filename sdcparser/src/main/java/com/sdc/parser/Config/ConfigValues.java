...
public class ConfigValues {
    ...
    public ConfigValues() throws IOException {
        ...
        try {
            ...
            patientConfig = new PatientConfig(prop.getProperty("patient.identifier"), prop.getProperty("patient.first.name"), prop.getProperty("patient.last.name"),
            ...
            practitionerSystem.put(prop.getProperty("practitioner.someIdentifier.key"), prop.getProperty("practitioner.someIdentifier.value"));
            practitionerSystem.put(prop.getProperty("practitioner.hl7.key"), prop.getProperty("practitioner.hl7.value"));
            
            practitionerConfig = new PractitionerConfig(prop.getProperty("practitioner.identifier"), prop.getProperty("practitioner.first.name"),
            prop.getProperty("practitioner.last.name"), practitionerSystem, prop.getProperty("practitioner.address"),
